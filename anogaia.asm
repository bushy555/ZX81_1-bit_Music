...
;        out  ($FE),a
	...
	in   a,($fe)			; Cassette Output becomes Low
	jr   .loop
.hidc2: out  ($ff),a			; Cassette Output becomes High
...
AUTORUN:
	...
	PRINT AT 6,0;"æïèêïæ MUSIC SYNTH 48K","ãðåæó± SIMON C. TILLSON, 1989"
	PRINT AT 11,3;"MUSIC: ANO GAIA TITLE";TAB 3;"AUTHOR: ANDY MILLS, 1992"
