...
;        OUT     ($FE),A  ;(11)  ; output pulse
	...
	in a,($fe)	;[11]	Cassette Output becomes Low
	jp .LP		;[10]

.HP:	out ($ff),a	;[11]	Cassette Output becomes High
	jp .LP		;[10]
.LP:
...
AUTORUN:
	...
	PRINT AT 6,0;"æïèêïæ EARTH SHAKER","ãðåæó± MICHAEL BATTY, 1990"
	PRINT AT 10,0;"ãéððôæ±áï±ðñõêðïÆ"
	PRINT AT 12,0;"Õ  MUSIC: EARTH SHAKER TITLE";TAB 3;"AUTHOR: MICHAEL BATTY, 1990"
	PRINT AT 15,0;"×  MUSIC: HEADBANGER";TAB 3;"AUTHOR: SHIRU, 2017"
